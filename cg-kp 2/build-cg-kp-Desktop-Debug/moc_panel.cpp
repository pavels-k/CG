...
QT_MOC_LITERAL(11, 151, 13), // "pointsChanged"
QT_MOC_LITERAL(12, 165, 12) // "handleButton"
...
void Panel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 9: _t->pointsChanged((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 10: _t->handleButton(); break;
        default: ;
        }
        ...
        {
            typedef void (Panel::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Panel::pointsChanged)) {
                *result = 9;
            }
        }
    }
...
// SIGNAL 9
void Panel::pointsChanged(double _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
