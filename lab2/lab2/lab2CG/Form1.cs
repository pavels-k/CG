...
Шевчук П.В.М80-304Б
Вариант 15
Каркасная визуализация восьмигранной пирамиды,
обеспечить возможность пространственных поворотов и масштабирования многогранника
 */
using System;
...
namespace lab2CG
{
    public partial class Form1 : Form
    {
        ...
        public void calcPyramid()
        {
            ...
            // 16 треугольников добавить в список pyramid
            pyramid.Add(a);
            pyramid.Add(b);
            pyramid.Add(c);
            pyramid.Add(d);
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (izometrCheckBox.Checked) { tr = sc * m1 * m2 * rtx * rty; tr = (sh * 2) * tr; } // измометрия
            else tr = sh * sc * rtx * rty; // без изометрии

            for (int i = 0; i < surfaces[cur].Count; ++i)
            {
                Triangle t = tr * surfaces[cur][i];
                t.Draw(pen, e.Graphics, invLinCheckBox.Checked); // невидимые линии
            }
        }
